from sqlalchemy import BigInteger, Boolean, Column, Date, ForeignKey, Integer, JSON, SmallInteger, String, TIMESTAMP, text
...
class BudgetItem(Base):
  ...
  id = Column(BigInteger, primary_key=True, index=True)
  income_id = Column(BigInteger, ForeignKey("budget_incomes.id", ondelete="CASCADE"), nullable=False, index=True)
